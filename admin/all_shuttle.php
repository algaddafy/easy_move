...
?>
    ...
    <head>
        ...
        <title>Easy Move: All Shuttle Timing</title>
        ...
        <div class="main_content" id="main-content">
            ...
            <div class="page">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="javascript:void(0);">All Shuttle Timing</a>
                </nav>
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="header">
                                    <h2><strong>All Shuttle</strong> Timing </h2>
                                </div>
                                <div class="body">
                                                ...
                                                <tr>
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $row) {               ?>
                                                            ...
                                                            <td><a href="edit_shuttle.php?editid=<?php echo htmlentities($row->ID); ?>"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                                </tr>
                                        <?php $cnt = $cnt + 1;
                                                        }
                                                    } ?>
